# DEPLOY_HF.md — backend on Hugging Face (free, no card)

Hugging Face Docker Spaces run any Dockerfile for free with no credit card. This is
the zero-cost path. A script does the create + upload + all non-secret config; you
do the login and paste 4 secrets.
